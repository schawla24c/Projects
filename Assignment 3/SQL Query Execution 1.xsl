	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>SQL Query Execution 1</title>
				<style type="text/css"></style>
			</head>
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="WIDTH: 0.5104in"/>
						<col style="WIDTH: 0.6979in"/>
						<col style="WIDTH: 0.8541in"/>
						<col style="WIDTH: 0.6979in"/>
						<col style="WIDTH: 0.9791in"/>
						<col style="WIDTH: 0.7916in"/>
						<col style="WIDTH: 1.9375in"/>
						<col style="WIDTH: 0.927in"/>
						<col style="WIDTH: 1.2812in"/>
						<col style="WIDTH: 0.9062in"/>
						<col style="WIDTH: 0.75in"/>
						<col style="WIDTH: 0.6979in"/>
						<col style="WIDTH: 0.6979in"/>
						<col style="WIDTH: 0.6041in"/>
						<col style="WIDTH: 1.4166in"/>
						<col style="WIDTH: 0.5625in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>ORD_ID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_DATE</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_PO_NUM</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>VEN_CODE</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_TOT_COST</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_LINE_ID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_LINE_DESC</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_LINE_QTY</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_LINE_UNIT_COST</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ORD_LINE_TOT</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>TY_GROUP</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>TY_CLASS</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>TY_CATEG</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>TY_TYPE</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>TY_DESCR</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>TY_UNIT</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="SQL_x0020_Query_x0020_Execution_x0020_1">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('ORD_DATE', 'Medium Date', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="ORD_PO_NUM"/>
								</td>
								<td>
									<xsl:value-of select="VEN_CODE"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('ORD_TOT_COST', 'Fixed', '2', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="ORD_LINE_ID"/>
								</td>
								<td>
									<xsl:value-of select="ORD_LINE_DESC"/>
								</td>
								<td>
									<xsl:value-of select="ORD_LINE_QTY"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('ORD_LINE_UNIT_COST', 'Fixed', '2', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('ORD_LINE_TOT', 'Fixed', '2', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="TY_GROUP"/>
								</td>
								<td>
									<xsl:value-of select="TY_CLASS"/>
								</td>
								<td>
									<xsl:value-of select="TY_CATEG"/>
								</td>
								<td>
									<xsl:value-of select="TY_TYPE"/>
								</td>
								<td>
									<xsl:value-of select="TY_DESCR"/>
								</td>
								<td>
									<xsl:value-of select="TY_UNIT"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
